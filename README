.. -*- mode: rst -*-
==========================================
 Keyboards for the Votic language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Votic language. The data and implementations
...
* http://giellatekno.uit.no/votdoc/index.html
* https://giellalt.uit.no/tools/docu-vot-manual.html
...
The Votic keyboard sources can be acquired using the `Giella SVN
